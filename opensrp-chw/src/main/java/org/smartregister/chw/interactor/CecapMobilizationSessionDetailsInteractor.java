...
public class CecapMobilizationSessionDetailsInteractor extends CoreBaseAncMedicalHistoryInteractor {
    ...
    public void getMemberHistory(final String memberID, final Context context, final BaseAncMedicalHistoryContract.InteractorCallBack callBack) {
        final Runnable runnable = () -> {
            ...
            String[] eventTypes = new String[]{CECAP_HEALTH_EDUCATION_MOBILIZATION};
