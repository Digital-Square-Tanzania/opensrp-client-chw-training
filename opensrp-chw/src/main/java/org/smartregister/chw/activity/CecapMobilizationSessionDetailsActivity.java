...
import static org.smartregister.chw.cecap.util.Constants.FORMS.CECAP_MOBILIZATION_SESSION;
...
import org.smartregister.chw.interactor.CecapMobilizationSessionDetailsInteractor;
...
public class CecapMobilizationSessionDetailsActivity extends CoreAncMedicalHistoryActivity {
    ...
    public static void startMe(Activity activity, String baseEntityId) {
        Intent intent = new Intent(activity, CecapMobilizationSessionDetailsActivity.class);
        activity.startActivity(intent);
        CecapMobilizationSessionDetailsActivity.baseEntityId = baseEntityId;
    }

    @Override
    public void initializePresenter() {
        presenter = new BaseAncMedicalHistoryPresenter(new CecapMobilizationSessionDetailsInteractor(), this, baseEntityId);
    }
    ...
    public void setUpView() {
        ...
        ((TextView) findViewById(R.id.medical_history)).setText(getString(R.string.cecap_mobilization_session_details));
    }
    ...
    public View renderView(List<Visit> visits) {
        ...
        visitTitle.setText(R.string.cecap_mobilization_session);
        return view;
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == JsonFormUtils.REQUEST_CODE_GET_JSON && resultCode == RESULT_OK) {
            ...
            try {
                ...
                if (encounterType.equals(CECAP_HEALTH_EDUCATION_MOBILIZATION)) {
                    ...
                    Event baseEvent = org.smartregister.chw.anc.util.JsonFormUtils.processJsonForm(allSharedPreferences, CoreReferralUtils.setEntityId(jsonString, baseEntityId), Constants.TABLES.CECAP_MOBILIZATION_SESSIONS);
    ...
    private static class SbcMobilizationSessionDetailsActivityFlv extends DefaultAncMedicalHistoryActivityFlv {
        ...
        public void processViewData(List<Visit> visits, Context context) {
            ...
            if (visits.size() > 0) {
                ...
                while (x < visits.size()) {
                    ...
                    String[] healthEducationMobilizationLocation = {"mobilization_date","female_clients_reached","male_clients_reached","mobilization_location","health_education_provided"};
                ...
                for (LinkedHashMap<String, String> vals : community_visits) {
                    ...
                    tvEdit.setOnClickListener(view1 -> {
                        ...
                        if (visit.getBaseEntityId() != null) {
                            startFormForEdit(R.string.cecap_mobilization_session, CECAP_MOBILIZATION_SESSION, visit.getBaseEntityId(), visit.getVisitId(), context);
                    ...
                    if (CECAP_HEALTH_EDUCATION_MOBILIZATION.equals(visits.get(x).getVisitType())) {
                        visitType = context.getString(R.string.cecap_mobilization_session);
                    } else {
        ...
        public void startFormForEdit(Integer title_resource, String formName, String baseEntityId, String deletedVisitId, Context context) {
            try {
                ...
                Event event = getEditEvent(baseEntityId, CECAP_HEALTH_EDUCATION_MOBILIZATION);

                final List<Obs> observations = event.getObs();
                JSONObject form = getFormWithMetaData(baseEntityId, context, formName, CECAP_HEALTH_EDUCATION_MOBILIZATION);
