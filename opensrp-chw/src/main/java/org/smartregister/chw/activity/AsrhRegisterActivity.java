...
import org.smartregister.chw.core.activity.CoreAsrhRegisterActivity;
import org.smartregister.chw.fragment.CecapMobilizationRegisterFragment;
import org.smartregister.chw.fragment.AsrhRegisterFragment;
import org.smartregister.view.fragment.BaseRegisterFragment;

public class AsrhRegisterActivity extends CoreAsrhRegisterActivity {

    public static void startRegistration(Activity activity, String baseEntityId) {
        Intent intent = new Intent(activity, AsrhRegisterActivity.class);
        intent.putExtra(Constants.ACTIVITY_PAYLOAD.BASE_ENTITY_ID, baseEntityId);
        intent.putExtra(Constants.ACTIVITY_PAYLOAD.ACTION, Constants.ACTIVITY_PAYLOAD_TYPE.REGISTRATION);
        intent.putExtra(Constants.ACTIVITY_PAYLOAD.ASRH_FORM_NAME, Constants.FORMS.ASRH_ENROLLMENT);
    ...
    public Form getFormConfig() {
        ...
        form.setWizard(true);
        form.setName(getString(R.string.asrh_registration));
    ...
    protected BaseRegisterFragment getRegisterFragment() {
        return new AsrhRegisterFragment();
    }
