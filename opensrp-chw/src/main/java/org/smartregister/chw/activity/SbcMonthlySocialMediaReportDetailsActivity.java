...
import org.smartregister.chw.interactor.SbcMonthlySocialMediaReportDetailsInteractor;
...
public class SbcMonthlySocialMediaReportDetailsActivity extends CoreAncMedicalHistoryActivity {
    private static String baseEntityId;
    private final Flavor flavor = new SbcMobilizationSessionDetailsActivityFlv();
    private ProgressBar progressBar;

    public static void startMe(Activity activity, String baseEntityId) {
        Intent intent = new Intent(activity, SbcMonthlySocialMediaReportDetailsActivity.class);
        activity.startActivity(intent);
        SbcMonthlySocialMediaReportDetailsActivity.baseEntityId = baseEntityId;
    }

    @Override
    public void initializePresenter() {
        presenter = new BaseAncMedicalHistoryPresenter(new SbcMonthlySocialMediaReportDetailsInteractor(), this, baseEntityId);
    }
    ...
    public void setUpView() {
        ...
        tvTitle.setText(getString(R.string.sbc_back_to_all_monthly_social_media_reports));

        ((TextView) findViewById(R.id.medical_history)).setText(getString(R.string.sbc_monthly_social_media_report_details));
    }
    ...
    public View renderView(List<Visit> visits) {
        ...
        sbcVisitTitle.setText(R.string.sbc_monthly_social_media_report_details);
        return view;
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == JsonFormUtils.REQUEST_CODE_GET_JSON && resultCode == RESULT_OK) {
            ...
            try {
                ...
                if (encounterType.equals(SBC_MONTHLY_SOCIAL_MEDIA_REPORT)) {
                ...
                Timber.e(e, "SbcMonthlySocialMediaReportDetailsActivity -- > onActivityResult");
            }
        }
    }
    ...
    private static class SbcMobilizationSessionDetailsActivityFlv extends DefaultAncMedicalHistoryActivityFlv {
        ...
        public void processViewData(List<Visit> visits, Context context) {
            ...
            if (visits.size() > 0) {
                ...
                while (x < visits.size()) {
                    ...
                    String[] mobilizationSessionDetails = {"reporting_month", "organization_name", "other_organization_name", "social_media_hiv_msg_distribution", "number_beneficiaries_reached_facebook", "number_messages_publications", "number_aired_messages_broadcasted"};
        ...
        public void startFormForEdit(Integer title_resource, String formName, String baseEntityId, String deletedVisitId, Context context) {
            try {
                ...
                Event event = getEditEvent(baseEntityId, SBC_MONTHLY_SOCIAL_MEDIA_REPORT);

                final List<Obs> observations = event.getObs();
                JSONObject form = getFormWithMetaData(baseEntityId, context, formName, SBC_MONTHLY_SOCIAL_MEDIA_REPORT);
